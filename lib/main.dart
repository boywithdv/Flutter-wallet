...
class _HomePageState extends State<HomePage> {
  ...
  List<dynamic> _services = [
    ['共有', Iconsax.export_1, Colors.blue],
    ['入金', Iconsax.import, Colors.pink],
    ['請求額', Iconsax.wallet_3, Colors.orange],
    ['詳細', Iconsax.more, Colors.green],
  ];

  List<dynamic> _transactions = [
    ['Amazon', 'https://img.icons8.com/color/2x/amazon.png', '6:25pm', '8900円'],
    ['Cash from ATM', 'https://img.icons8.com/external-kiranshastry-lineal-color-kiranshastry/2x/external-atm-banking-and-finance-kiranshastry-lineal-color-kiranshastry.png', '5:50pm', '200,000円'],
    ['Netflix', 'https://img.icons8.com/color-glass/2x/netflix.png', '2:22pm', '1400円'],
    ['Apple Store', 'https://img.icons8.com/color/2x/mac-os--v2.gif', '6:25pm', '4000円'],
    ['Cash from ATM', 'https://img.icons8.com/external-kiranshastry-lineal-color-kiranshastry/2x/external-atm-banking-and-finance-kiranshastry-lineal-color-kiranshastry.png', '5:50pm', '200,000円'],
    ['Netflix', 'https://img.icons8.com/color-glass/2x/netflix.png', '2:22pm', '1400円']
  ];
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Image.asset('assets/images/j.tsukuda.JPG')
                ),
                SizedBox(height: 10,),
                Padding(
                  padding: EdgeInsets.only(left: 30.0),
                  child: Text("j.tsukuda", 
                    ...
                    children: [
                      ...
                      FadeIn(
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () {},
                          child: Text('追加', style: TextStyle(color: Colors.black, fontSize: 10),),
                  ...
                  children: [
                    FadeInDown(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('総資産', style: TextStyle(color: Colors.grey.shade800, fontSize: 14, fontWeight: FontWeight.w600),),
                          SizedBox(width: 10,),
                          Text('1,840,000', style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.w700,)),
                        ]
                      ),
                    ),
                    Expanded(
